...
struct SettingsAPIFixture {
    ...
    SettingsAPIFixture() {
        ...
        kJSONContent =
        "{"
        "   \""+SettingNodeConstants::kMyNode0Key+"\": \""+SettingNodeConstants::kMyNode0Value+"\","
...
//	SettingNodeInterface* rootNode = api->readConfigurationFile(test::kJSONContent);
    ...
    BOOST_REQUIRE_EQUAL(rootNode->getType(), SettingNodeConstants::kMyNode2Type);
    ...
    BOOST_REQUIRE_EQUAL(myNode0->readString(), SettingNodeConstants::kMyNode0Value);
    ...
    BOOST_REQUIRE_EQUAL(myNode1_Node0->getType(), SettingNodeConstants::kMyNode0Type);
    BOOST_REQUIRE_EQUAL(myNode1_Node0->readString(), SettingNodeConstants::kMyNode0Value);

    SettingNodeInterface* myNode1_Node1 = myNode1Children[1];
    BOOST_REQUIRE_EQUAL(myNode1_Node1->getType(), SettingNodeConstants::kMyNode1Type);
    std::vector<SettingNodeInterface*> myNode1_Node1Children = myNode1_Node1->getChildren();
    BOOST_REQUIRE_EQUAL(myNode1_Node1Children.size(), 1);
    SettingNodeInterface* myNode1_Node1_Node0 = myNode1_Node1Children[0];
    BOOST_REQUIRE_EQUAL(myNode1_Node1_Node0->getType(), SettingNodeConstants::kMyNode2Type);
    
    SettingNodeInterface* myNode1_Node2 = myNode1Children[2];
    BOOST_REQUIRE_EQUAL(myNode1_Node2->getType(), SettingNodeConstants::kMyNode2Type);
    std::vector<SettingNodeInterface*> myNode1_Node2Children = myNode1_Node2->getChildren();
    BOOST_REQUIRE_EQUAL(myNode1_Node2Children.size(), 1);
    SettingNodeInterface* myNode1_Node2_Node0 = myNode1_Node2Children[0];
    BOOST_REQUIRE_EQUAL(myNode1_Node2_Node0->getType(), SettingNodeConstants::kMyNode0Type);
    ...
    for(int i=0; i<myNode2Children.size(); i++)
    {
        ...
        BOOST_REQUIRE_EQUAL(myNode2_Node0->getType(), SettingNodeConstants::kMyNode0Type);
        BOOST_REQUIRE_EQUAL(myNode2_Node0->getKey(), SettingNodeConstants::kMyNode0Key);
        BOOST_REQUIRE_EQUAL(myNode2_Node0->readString(), SettingNodeConstants::kMyNode0Value);
    }
}
