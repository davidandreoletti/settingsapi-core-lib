...
const settingsapi::SettingNodeInterface::Type SettingNodeConstants::kMyNode0Type = settingsapi::SettingNodeInterface::TYPE_VALUE;  // NOLINT(whitespace/line_length)
const std::string SettingNodeConstants::kMyNode0Key = "david";
const std::string SettingNodeConstants::kMyNode0Value = "ling";
const settingsapi::SettingNodeInterface::Type SettingNodeConstants::kMyNode1Type = settingsapi::SettingNodeInterface::TYPE_ARRAY;  // NOLINT(whitespace/line_length)
const std::string SettingNodeConstants::kMyNode1Key = "tiny";
const settingsapi::SettingNodeInterface::Type SettingNodeConstants::kMyNode2Type = settingsapi::SettingNodeInterface::TYPE_OBJECT;  // NOLINT(whitespace/line_length)
...
settingsapi::SettingNodeInterface* SettingNodeConstants::createNewValueNode() {
    ...
    api::SettingNodeInterface* n = (api::SettingNodeInterface*) new api::SettingNode();  // NOLINT(whitespace/line_length)
...
settingsapi::SettingNodeInterface* SettingNodeConstants::createNewEmptyArrayNode() {  // NOLINT(whitespace/line_length)
    namespace api = settingsapi;
    api::SettingNodeInterface* n = (api::SettingNodeInterface*) new api::SettingNode();  // NOLINT(whitespace/line_length)
...
settingsapi::SettingNodeInterface* SettingNodeConstants::createNewEmptyObjectNode() {  // NOLINT(whitespace/line_length)
    namespace api = settingsapi;
    api::SettingNodeInterface* n = (api::SettingNodeInterface*) new api::SettingNode();  // NOLINT(whitespace/line_length)
...
settingsapi::SettingNodeInterface* SettingNodeConstants::createNewNotEmptyArrayNode() {  // NOLINT(whitespace/line_length)
    namespace api = settingsapi;
...
settingsapi::SettingNodeInterface* SettingNodeConstants::createNewNotEmptyObjectNode() {  // NOLINT(whitespace/line_length)
    namespace api = settingsapi;
